...
pdf("../book/graphics/gasplot.pdf", width=3, height=6)
par(mai=c(.8,.8,0,0))
...
pdf("../book/graphics/gasfit.pdf", width=5, height=2.5)
par(mai=c(.8,.8,.0,0))
...
pdf("../book/graphics/GASpls.pdf", width=8, height=3)
...
pdf("../book/graphics/gasselect.pdf", width=6, height=3)
